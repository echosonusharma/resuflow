...
import type { TemplateProps, ReadCustomize } from '../../types';

registerFonts();

const PAGE_SIZE_MAP = { A4: 'A4', Letter: 'LETTER', A5: 'A5' };

function SectionHeading({ heading, c, headingFont }: { heading: string; c: ReadCustomize; headingFont: string }) {
...
export default function ClassicClearPdf({ personal, sections, customize }: TemplateProps) {
