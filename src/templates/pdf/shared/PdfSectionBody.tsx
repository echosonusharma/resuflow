...
export interface PdfCustomize extends ReadCustomize {
  textColor?: string;
  subTextColor?: string;
}

interface PdfContactRowProps {
 ...
 */
export function PdfContactRow({ personal, c, iconColor, itemStyle = {}, stacked = false }: PdfContactRowProps) {
 ...
 */
export function PdfFooter({ personal, customize }: { personal: PersonalInfo; customize?: Customize }) {
 ...
 */
export default function PdfSectionBody({ section, c, twoColLang = false }: PdfSectionBodyProps) {
  ...
  const renderDatedEntry = (
    entry: { id: string; startDate: string; endDate: string; bullets?: string[] },
    title: string,
