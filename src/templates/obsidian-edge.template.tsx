...
import type { Section, SectionType, ExperienceEntry, EducationEntry, SkillsEntry, LanguageEntry, CertEntry, TemplateMeta, TemplateProps, ReadCustomize } from '../types';
...
export default function ObsidianEdge({ personal, sections, customize = {} }: TemplateProps) {
