...
import { usePersonal, useCustomize, useSections, useActiveTemplate } from '../hooks/index';
import { useResumeStore } from '../store/resumeStore';
import { exportPdfReact } from '../utils/exportPdfReact';
...
export default function Header({ view, setView, onExit }: HeaderProps) {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      alertDialog(`PDF generation failed: ${err instanceof Error ? err.message : 'Unknown error'}`, { title: 'Download failed' });
    } finally {
