...
export default function ColorsSettings({ customize, updateCustomize }) {
  ...
  return (
    <Card id="colors" title="Colors">
      ...
      <div className="cz-palette-grid">
        {PALETTES.map((pal, i) => (
          <div key={i} className={`cz-palette-item ${paletteIndex === i ? 'active' : ''}`}
            onClick={() => updateCustomize('colors', { paletteIndex: i })}>
        ...
        <div className="cz-palette-item cz-palette-custom">
