...
import { useActiveTemplate, usePersonal, useSections } from '../../hooks/index';
import { getPageFormat } from '../../utils/pageFormat';
...
function computePageSlices(measureEl: HTMLElement, pageH: number): PageSlice[] {
  ...
  function budget(isFirst: boolean): number { return isFirst ? pageH : pageH - CONTINUATION_PAD; }
...
export default function PreviewPanel() {
  ...
  const [pageSlices, setPageSlices] = useState<PageSlice[]>([{ start: 0, end: 0 }]);
