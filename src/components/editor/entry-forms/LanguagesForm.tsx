...
import type { EntryFormProps, LanguageEntry } from '../../../types';

export default function LanguagesForm({ sectionId, entry }: EntryFormProps<LanguageEntry>) {
  const { updateEntry } = useSections();
  function update(data: Partial<LanguageEntry>) {
